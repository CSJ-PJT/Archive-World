...
for required in ('raised-sidewalk','curb','crosswalk','transit-shelter','archive-plaza','ledger-plaza','station-entrance','tree-trunk','tree-crown-lobe','vehicle-body','vehicle-wheel','human-torso','human-head','lane-marking-dash','midDetailPopulation'):
