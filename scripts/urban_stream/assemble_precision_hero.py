...
def assemble(v11: Path, v12: Path, hero_version: str = "v26",
    ...
    manifest["heroZones"] = [{
        ...
        "geometry": report["geometry"], "geometryRevision": report.get("geometryRevision", report["revision"]), "lobbies": report["lobbyCount"],
    ...
    if expanded_report:
        manifest["heroZones"].append({
            ...
            "geometryRevision": expanded_report.get("geometryRevision", expanded_report["revision"]),
