...
def main():
    ...
    comparison='<h2>Frozen baselines and V6</h2><div class=grid><figure><img src="before-v5-day-hero.png"><figcaption>Residential V5 · 76/C</figcaption></figure><figure><img src="../residential/previews/day-hero-front.png"><figcaption>Residential V6 · 82/B</figcaption></figure><figure><img src="office-v5-day-hero.png"><figcaption>Office V5 frozen · 82/B</figcaption></figure></div>'
    html=f'<!doctype html><meta charset=utf-8><title>Residential V6 Review</title><style>body{{font:16px system-ui;background:#182028;color:#eee;margin:24px}}.grid{{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}}figure{{margin:0;background:#26323d;padding:7px}}img{{width:100%}}figcaption{{font-size:12px;padding-top:5px}}</style><h1>Residential V6 — {total}/100 B · PO review candidate</h1><p>Procedural-only; canonical false; city-applied false. Office V5 frozen at 82/B.</p>{comparison}<h2>Residential V6 twenty-view review</h2><div class=grid>{figures}</div>'
