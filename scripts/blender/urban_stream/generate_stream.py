...
from micro_architecture import build_micro_architecture
...
def main():
 ...
 edge=build_edges(batch,alignment['segments']);bridges=build_bridges(batch,alignment['bridges']);nodes=build_nodes(batch,alignment['nodes']);micro=build_micro_architecture(batch);activity=build_landscape_activity(batch,alignment['segments'],alignment['nodes'])
