...
function proceduralWaterMaterial(performance=false){
 const water=new THREE.MeshStandardMaterial({name:performance?'hero-water-performance':'hero-water-cinematic',color:0x0a3f4b,roughness:performance?.56:.46,metalness:.0,transparent:false});
