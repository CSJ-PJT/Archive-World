...
const cameras:CameraPreset[]=[
 ...
 {name:'hero-s-street-axis',position:[-333,1.65,-21],target:[-218,3.2,1]},
 {name:'hero-s-frontage',position:[-352,1.65,-39],target:[-326,4.1,-75]},
 {name:'hero-s-water-plaza',position:[-310,1.65,34],target:[-255,3.1,0]},
 {name:'hero-s-gateway',position:[-294,1.65,29],target:[-250,3.8,0]},
];
